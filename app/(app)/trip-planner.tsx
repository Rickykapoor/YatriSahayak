...
const TripPlannerScreen: React.FC = () => {
  ...
  const renderTabButton = (tab: TabType, title: string, badge?: number) => (
    ...
    >
      <Text className={`text-sm font-medium text-center ${activeTab === tab ? 'text-primary' : 'text-gray-500'}`}>
        {title}
      </Text>
      {badge && badge > 0 && (
  ...
  return (
    <View className="flex-1 bg-gray-light">
      {/* Header */}
      <View className="bg-white pt-14 px-4 pb-4 border-b border-gray-border">
        <Text className="text-2xl font-bold text-black mb-4">Trip Planner</Text>
      ...
      <ScrollView className="flex-1">
        {activeTab === 'plan' && (
          <View>
            {/* Search Bar */}
            <View className="flex-row items-center bg-white m-4 px-4 py-3 rounded-xl">
            ...
            {/* Quick Start Options */}
            <View className="m-4">
              <Text className="text-xl font-semibold text-black mb-3">Quick Start</Text>
              <View className="flex-row gap-3">
                ...
                >
                  ...
                  <Text className="text-sm font-medium text-black text-center mt-2">Weekend Getaway</Text>
                </Pressable>
                ...
                >
                  ...
                  <Text className="text-sm font-medium text-black text-center mt-2">Long Vacation</Text>
                </Pressable>
                ...
                >
                  ...
                  <Text className="text-sm font-medium text-black text-center mt-2">Business Trip</Text>
                </Pressable>
              </View>
            </View>
            ...
            <View className="m-4">
              <Text className="text-xl font-semibold text-black mb-3">Popular Destinations</Text>
