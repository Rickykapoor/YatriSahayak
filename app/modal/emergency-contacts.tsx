      ...
      <View className="flex-row justify-between items-start mb-2">
        <View className="flex-1">
          <View className="flex-row items-center mb-1">
            <Text className="text-lg font-semibold text-black">{contact.name}</Text>
            {contact.isPrimary && (
          ...
          <Text className="text-base text-gray-700 mb-1">{contact.phone}</Text>
          <Text className="text-sm text-gray-500">{contact.relationship}</Text>
        </View>
        
        <View className="flex-row gap-2">
          <Pressable 
            className="bg-success p-3 rounded-full"
  ...
  return (
    <View className="flex-1 bg-gray-light">
      ...
      <ScrollView className="flex-1 p-4">
        ...
        <View className="bg-danger/10 p-4 rounded-xl mb-4 border border-danger/20">
        ...
        {showAddForm && (
          <View className="bg-white p-4 rounded-xl shadow-sm">
            <Text className="text-lg font-semibold text-black mb-4">Add Emergency Contact</Text>
